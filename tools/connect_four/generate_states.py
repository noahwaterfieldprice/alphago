...
def combine_connect_four_states_files(
    input_filepaths: Iterable[str], output_filepath: str
) -> None:
    ...
    with open(output_filepath, "w") as output_file:
        lines = "\n".join(
            [" ".join(map(str, solution)) for solution in sorted_solutions]
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "min_moves", help="The minimum number of moves for each sequence"
    )
