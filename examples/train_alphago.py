...
def create_estimator():
    return ConnectFourNet(
        learning_rate=learning_rate, action_indices=game.action_indices
    )
...
losses = train_alphago(
    game,
    create_estimator,
    self_play_iters=self_play_iters,
    ...
    num_evaluate_games=num_evaluate_games,
    win_rate=win_rate,
