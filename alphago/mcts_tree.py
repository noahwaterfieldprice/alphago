...
class MCTSTree:
    ...
    def __init__(self, game_state):
        # Each node is an MCTSNode. It stores its children, action_count,
        # action_value, action_value_sum, and prior_probability.
        
        # It takes in the game state at the root. Initially this is a leaf
        # node, so we give prior_prob None.
        self.root = MCTSNode(None, game_state)
    ...
    def select(self, max_steps, c_puct):
        ...
        while not MCTSTree.is_leaf(node) and num_steps < max_steps:
            ...
            ucb = MCTSTree.compute_ucb(action_values, prior_probs, action_counts, c_puct)
